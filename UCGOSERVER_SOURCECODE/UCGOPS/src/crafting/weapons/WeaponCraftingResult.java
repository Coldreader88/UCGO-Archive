 ...
 *
 *
 * Denne klassen brukes til å representere resultatet etter våpen crafting.
 */
public class WeaponCraftingResult {

    /**
     * Resultatet av våpen crafting.
     *
     * true=vellykket.
     */
     ...
     * våpenet, dersom mislykket er det ID til materialet som skal plasseres i
     * factory.
     */
    private int itemID;
